...
#             label='请选择大语言模型:',
#             options=['qwen:4b', 'qwen:4b']
#         )
#         choice = 'qwen:4b' if selected_option == 'qwen:4b' else 'qwen:4b'
